    ...
    return ListView(
      ...
      children: [
        ...
        if (blocks.isEmpty)
          ...
          // Horizontal list of BlockCards. The 200px height is the
          // carousel design choice; the BlockCard naturally fits at
          // ~184px (100px image + 84px content) so 200px provides
          // breathing room. If tag chips are ever added, revisit
          // the height here. (Originally overflowed by 4px when the
          // image was 120px; the image is now 100px.)
          SizedBox(
            height: 200,
            child: ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                return Padding(
                  padding: const EdgeInsets.only(right: Spacing.space_sm),
                  child: SizedBox(
                    width: 240,
                    child: BlockCard(
                      block: block,
        ...
        if (meetings.isEmpty)
          Padding(
            ...
            child: AppEmpty(
              ...
              message: "Nenhuma reuniao esta semana",
            ),
          )
        else
          Padding(
