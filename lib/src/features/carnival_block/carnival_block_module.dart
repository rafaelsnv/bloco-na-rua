import 'package:bloco_na_rua/src/features/carnival_block/data/repositories/firestore_carnival_block_repository.dart';
...
import 'package:bloco_na_rua/src/features/carnival_block/ui/pages/join_block_page.dart';
...
class CarnivalBlockModule extends Module {
  ...
  void routes(RouteManager r) {
    r
      ...
      ..child(
        '/block/join_block',
        child: (context) => const JoinBlockPage(),
      );
  }
}
